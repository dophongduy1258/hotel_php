<?php
class selling_type extends model{

    protected $class_name = 'selling_type';
    protected $id;
    protected $name;
    protected $root_id;
    ...
    public function list_by_root(){
        ...
        $sql = "SELECT * FROM $db->tbl_fix$this->class_name WHERE `root_id` = '$root_id' ORDER BY `id` ASC ";
