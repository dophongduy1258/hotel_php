...
class paging
{
	...
	// 			$start = $this->page - $this->limitpage;
	// 			if (($this->page - $this->limitpage) > 0) $this->html.="<li><a class='demtrang' href='".sprintf($this->url,"1")."'>Trang đầu</a></li><li style='border:none;background:none;padding-top:10px;'>...</li><li><a title='trở lại' class='demtrang' href='".sprintf($this->url,$start)."'><<</a></li>";
	// 			// ======================
	// 			if ($this->page > $this->limitpage){
	...
	// 				for ($i = $start; $i <= $end; $i++ ){
	// 					if ($this->page == $i){
	// 						$this->html .= "<li class=\"active\" ><a class='demtrang' href='".sprintf($this->url,$i)."'>".$i."</a></li>";
	// 					} else {
	// 						$this->html .= "<li><a class='demtrang' href='".sprintf($this->url,$i)."'>".$i."</a></li>";
	// 					}
	// 				}
	// 			} else {
	// 				for ($i = 1; $i <= $this->maxpage ; $i++ ){
	...
	// 			if ((($this->page - $this->limitpage) < $this->total_page) & ($this->total_page - $this->page) > $this->limitpage){
	// 				$this->html .= "<li><a title='Next' class='demtrang' href='".sprintf($this->url,$i)."'>>></a></li><li style='border:none;background:none;padding-top:10px;'>...</li><li><a title='Đi đến trang cuối cùng' class='demtrang' href='".sprintf($this->url,$this->total_page)."'>".($this->total_page)."</a></li>";
				
	// 				$this->html.="<li><a class='demtrang' href='".sprintf($this->url,$this->total_page)."'>Trang cuối</a></li>";
	// 			}
	// 		} else {
	// 			for($i=1;$i<=$this->total_page;$i++) {
	// 				if ($this->page == $i){
	...
	public function display_ajax3(){//No default page 1
		if ($this->totalpage()){
			if ($this->total_page > $this->maxpage){
				...
				$start = $this->page - $this->limitpage;
				if (($this->page - $this->limitpage) > 0) $this->html.="
					<li class='demtrang'  onclick='return paging_ajax3(1)'><a  href='javascript:;'>Trang đầu</a></li>
